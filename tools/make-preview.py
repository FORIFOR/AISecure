...
def build() -> str:
    ...
    head_extra = (
        ...
        '<link rel="canonical" href="https://forifor.github.io/AISecure/try.html">'
        '<meta property="og:site_name" content="AISecure · Reachmade Lab">'
        '<meta property="og:url" content="https://forifor.github.io/AISecure/try.html">'
